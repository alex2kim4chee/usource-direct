                ...
                <button
                  onClick={() =>
                    openLegalModal(
                      ...
                      'Настоящий сайт носит информационный характер. Мы не собираем персональные данные через формы на сайте. Все обращения направляются пользователем добровольно на адрес электронной почты partners@usource.direct.'
                    )
                  }
