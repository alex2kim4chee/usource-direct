...
For the Cloudflare zone `48260ce49d93de543531e13af9c08591`, point the apex domain and `www` to GitHub Pages:
...
GitHub Pages is configured with `usourcedirect.com` as the custom domain and HTTPS enforcement enabled.
